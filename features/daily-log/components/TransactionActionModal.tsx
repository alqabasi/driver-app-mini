...
export const TransactionActionModal: React.FC<TransactionActionModalProps> = ({ 
  ...
  onDelete 
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-end justify-center sm:p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
            ...
            <div className="bg-white w-full max-w-sm rounded-t-[2rem] sm:rounded-[2rem] overflow-hidden shadow-2xl animate-in slide-in-from-bottom-10 duration-200 relative z-10 p-6 pb-10">
                 ...
                 <div className="space-y-3">
                     <button 
                        ...
                        className="w-full flex items-center gap-4 p-4 bg-slate-50 rounded-2xl text-slate-800 font-bold active:bg-slate-100 transition-colors"
                     >
                     ...
                     <button 
                        ...
                        className="w-full flex items-center gap-4 p-4 bg-red-50 rounded-2xl text-red-600 font-bold active:bg-red-100 transition-colors"
                     >
                     ...
                     <button onClick={onClose} className="w-full p-4 text-slate-400 font-bold hover:text-slate-600">
                        إلغاء
                     </button>
                 </div>
            </div>
